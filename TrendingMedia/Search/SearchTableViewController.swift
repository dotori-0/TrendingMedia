...
class SearchTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        movieArray = [movie0, movie1, movie2, movie3, movie4, movie5, movie6, movie7]

        textFieldContainerView.backgroundColor = UIColor(named: "SearchViewTextFieldColor")
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "SearchTableViewCell", for: indexPath) as! SearchTableViewCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //        let title = movieArray[indexPath.row].title
        //        let release = movieArray.movie
